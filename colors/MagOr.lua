...
local function setup_cpp_colors()
	...
	Group.new("@lsp.typemod.operator.declaration.cpp", colors.aqua, nil, bold)
	Group.new("@lsp.type.namespace.cpp", colors.namespace, nil, bold)
