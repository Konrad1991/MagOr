...
local function setup_cpp_colors()
	Group.new("@lsp.type.function.cpp", colors.grey, colors.magenta, bold)
	Group.new("@lsp.type.variable.cpp", colors.grey, nil, bold)
	Group.new("@lsp.type.property.cpp", colors.grey, nil, bold)
	Group.new("@lsp.type.typeParameter.cpp", colors.orange, nil, bold)
	Group.new("@lsp.type.typeParameter.cpp", colors.orange, nil, bold)
	Group.new("@lsp.type.class.cpp", colors.grey, nil, bold)
	...
	Group.new("@lsp.type.method.cpp", colors.grey, colors.magenta, bold)
	Group.new("@lsp.type.unknown.cpp", colors.grey, colors.magenta, bold)
	Group.new("@lsp.type.macro.cpp", colors.grey, colors.magenta, bold)

	Group.new("@type.cpp", colors.orange, nil, bold)
	Group.new("@function.call.cpp", colors.grey, colors.magenta, bold)
	Group.new("@function.method.call.cpp", colors.grey, colors.magenta, bold)
	Group.new("@type.builtin.cpp", colors.orange, nil, bold)
	Group.new("@type.definition.cpp", colors.orange, nil, bold)
	Group.new("@variable.builtin.cpp", colors.grey, nil, bold)
