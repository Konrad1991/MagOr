...
local function setup_cpp_colors()
	Group.new("@lsp.type.function.cpp", colors.white, colors.magenta, bold)
	...
	Group.new("@lsp.type.method.cpp", colors.white, colors.magenta, bold)
	Group.new("@lsp.type.unknown.cpp", colors.white, colors.magenta, bold)
	Group.new("@lsp.type.macro.cpp", colors.white, colors.magenta, bold)

	Group.new("@type.cpp", colors.orange, nil, bold)
	Group.new("@function.call.cpp", colors.white, colors.magenta, bold)
	Group.new("@function.method.call.cpp", colors.white, colors.magenta, bold)
